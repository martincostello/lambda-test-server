...
public class ReverseFunctionWithCustomOptionsTests(ITestOutputHelper outputHelper) : FunctionTests(outputHelper)
{
    [Fact]
    public async Task Function_Reverses_Numbers_With_Custom_Options()
    {
        // Arrange
