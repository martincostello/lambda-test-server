...
The library itself targets `netcoreapp3.1` and `net6.0` so requires your test project to target at least .NET Core 3.1, but the function you're testing could target a previous version such as .NET Core 2.2.
