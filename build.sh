...
dotnet build ./AwsLambdaTestServer.sln --output $artifacts --configuration $configuration || exit 1
dotnet pack ./src/AwsLambdaTestServer/MartinCostello.Testing.AwsLambdaTestServer.csproj --output $artifacts --configuration $configuration || exit 1
